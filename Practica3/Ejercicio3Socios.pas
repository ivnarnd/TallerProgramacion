...
var
	nom:cadena15;
begin
	writeln('Ingrese un Nombre a Buscar de un Socio: ');
	readln(nom);
	if(ExisteNombre(a,nom))then
		writeln('El socio con Nombre: ',nom,' Se encuentra en el Arbol')
	else
		writeln('El socio con Nombre: ',nom,' No se encuentra en el Arbol');
...
var
	...
	cantSocios:integer;
begin
	edadAcum:=SumarEdades(a);
	CantSocios:=ContarSocios(a);
	writeln('El promedio de edad de los socios es: ',edadAcum div cantSocios);
end;
var a: arbol; 
Begin
  randomize;
